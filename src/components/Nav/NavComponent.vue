  ...
  <header class="text-gray-400 bg-gray-900 body-font sticky top-0 z-10">
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
      <router-link to="/" class="flex title-font font-medium items-center text-white mb-4 md:mb-0">
        ...
        <span class="ml-3 text-xl">Shoes-ya</span>
      </router-link>
      <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
        <router-link to="/" class="mr-5 hover:text-white cursor-pointer">Inicio</router-link>
      ...
      <div class="flex gap-x-3">
        ...
        <router-link to="/carrito" class="inline-flex items-center bg-gray-800 border-0 py-1 px-3 focus:outline-none hover:bg-gray-700 rounded text-base mt-4 md:mt-0 relative">
